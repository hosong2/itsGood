...
#all_popup5 .popup_table_sec{overflow-y:scroll;overflow-x:hidden;position:relative;height:586px;scrollbar-arrow-color:#d2d2d2;scrollbar-3dlight-color:#fff;scrollbar-highlight-color:#ccc;scrollbar-face-color:#FFF;scrollbar-shadow-color:#ccc;scrollbar-darkshadow-color:#fff;scrollbar-track-color:#fff}
#all_popup5 .popup_table_sec1{overflow:hidden;position:relative;height:853px;}


.popupLayer{position:absolute;top:0;left:0;z-index:100;width:100%;height:100%;-ms-filter:alpha(opacity=50);filter:alpha(opacity=50);opacity:0.53;-moz-opacity:0.3}
...
.tb2 th{padding:7px 0 6px 10px;border:1px solid #DDD;background:#f1f1f1;font-weight:bold;color:#4d4d4d;text-align:left;vertical-align:top;}
...
.but_73{width: 60px; height: 16px; text-align: center; display: inline-block; border: 1px solid #bebebe; background: #0079bc; padding: 4px 4px 4px 4px; cursor: pointer; color:#fff;font-weight: bold;}
	...
	<div class="popup_write">
		<div class="contents">
			<div class="popup_table">
				<div class="title"><p>좋았다 게시판</p></div>
				<div class="write_table" >
					...
					<div class="popup_btn_sec"><span class="addButton" type="button"onclick="location.href='boardlist.jsp'">등록</span>&nbsp;<span class="addButton" type="button" onClick="location.href='boardlist.jsp'">취소</span></div>
				</div>
			</div>
		</div>
	</div>
